...
const LayoutTwele = () => {
    ...
    return (
        <Box component="div" className={`${styles.Six_Two_Border_Images}  ${styles.custom_images_fit}`} style={{border: `${adjust_border_size}px solid ${adjust_border_color}`}}>
            <Grid container>
